...
import com.ibrahimmakashi.pkart.databinding.ActivityLoginBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button3.setOnClickListener {
            if (binding.userNumber.text!!.isEmpty())
             ...
             if(binding.userNumber.length() == 10) {
                 sendOtp(binding.userNumber.text.toString())
             }
                else{
                 Toast.makeText(this, "Please Provide right Number", Toast.LENGTH_SHORT).show()
             }
            }
        }
    }
